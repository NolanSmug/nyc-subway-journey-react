...
import UPCOMING_STATIONS_BLACK from '../../assets/images/upcoming-stations-icon-b.svg'
import UPCOMING_STATIONS_WHITE from '../../assets/images/upcoming-stations-icon-w.svg'
import UPCOMING_STATIONS_VERTICAL_BLACK from '../../assets/images/upcoming-stations-vertical-icon-b.svg'
import UPCOMING_STATIONS_VERTICAL_WHITE from '../../assets/images/upcoming-stations-vertical-icon-w.svg'
import UPCOMING_STATIONS_HORIZONTAL_BLACK from '../../assets/images/upcoming-stations-horizontal-icon-b.svg'
import UPCOMING_STATIONS_HORIZONTAL_WHITE from '../../assets/images/upcoming-stations-horizontal-icon-w.svg'
